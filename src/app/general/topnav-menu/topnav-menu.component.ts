...
@Component({
  ...
  styleUrls: ['./topnav-menu.component.scss']
})
export class TopnavMenuComponent implements OnInit {
  ...
  constructor(private toastr: ToastrService,private acrouter: ActivatedRoute, private router: Router, private formservice: FormService, private userservice: UserService, private fb: FormBuilder, ) {
